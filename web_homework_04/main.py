...
class GoitFramework(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        # Відправка даних на socket(UDP)-сервер
    ...
    def send_static(self, filename, status_code=200):
        # Відправлення статичних ресурсів
        self.send_response(status_code)
...
def run_socket_server(host, port):
    # Запуск socket(UDP)-сервера для обробки даних з форми
...
if __name__ == '__main__':
    # Запуск HTTP- та socket(UDP)-серверів у різних потоках
